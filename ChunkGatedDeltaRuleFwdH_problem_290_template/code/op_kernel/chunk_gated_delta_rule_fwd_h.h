    ...
    if ASCEND_IS_AIV {
        ...
        for (int64_t m = 0; m < kDim; ++m) {
            ...
            for (int64_t t = 0; t < actualLen; ++t) {
                ...
                Muls(prod, rowF, kt.GetValue(t * kDim + m), tile);
